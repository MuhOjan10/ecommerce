                ...
                <div class="card-body">
                    <form action="{{route('category.store')}}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="code" class="form-control" placeholder="input kode kategori disini">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="name" class="form-control" placeholder="input nama kategori disini">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <textarea rows="5" cols="5" name="description" class="form-control"
                                    placeholder="input keterangan kategori disini"></textarea>
                            </div>
                        </div>
